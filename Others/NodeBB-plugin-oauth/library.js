(function(module) {
	...
	*/
	...
	var constants = Object.freeze({
			...
			oauth2: {
				authorizationURL: 'https://4000v-cis-swen90014-wcplatypus-l.eng.unimelb.edu.au:443/dialog/authorize',
				tokenURL: 'https://4000v-cis-swen90014-wcplatypus-l.eng.unimelb.edu.au:443/oauth/token',
				clientID: 'wealth1',
				clientSecret: 'wealth2'
			},
			userRoute: 'https://4000v-cis-swen90014-wcplatypus-l.eng.unimelb.edu.au:443/api/userinfo',	// This is the address to your app's "user profile" API endpoint (expects JSON)
