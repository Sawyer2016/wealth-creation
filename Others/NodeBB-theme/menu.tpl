...
<div class="navbar-header">
				...
				<a href="{relative_path}/">
					<a class="navbar-brand forum-title">{title}</a>
				</a>
			...
			<div id="nav-dropdown" class="hidden-xs">
				...
				<ul id="main-nav" class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<li id="pi"><a href="/tools/personalInfo"><span style="color:white;">Profile<span class="border"></span></span></a>  </li>
						<li id="dp"><a href="/tools/debtPlan"><span style="color:white;">86 Debt Plan<span class="border"></span></span></a></li>
									<li id="es"><a href="/tools/expenseSnake"><span style="color:white;">Expense Snake<span class="border"></span></span></a></li>
						<li id="il"><a href="/tools/userIncome"><span style="color:white;">Income Ladder<span class="border"></span></span></a></li>
						<li id="em"><a href="/tools/userEvent"><span style="color:white;">Events<span class="border"></span></span></a></li>
						</ul>
						</li>
					<!-- ELSE -->
